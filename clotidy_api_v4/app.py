...
from category_model.category_api import app as category_app
from color_model.color_api import app as color_app
from clotidy_recommend.clotidy_recommend_api import app as recommend_app 
...
# Include endpoints from recommendation model
